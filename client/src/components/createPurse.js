        ...
        <div className = "create-purse">
            ...
            <div className = "create-purse-text">
                ...
                <p className = "create-purse-text-body">
                    New to Purse? A Purse is a Decentralized co-orperative (i.e, it requires no trust) where different individual come together to form a group with the aim of putting money together to be disbursed to each member of the Purse in turn till everyone gets his/her own
                </p>
            </div>
